...
\missingfigure{TODO: Illustrate the round message format, which will consist of,
  for each of the $\NumClients$ clients: space for a \texttt{Ballot}, and space for up to
$\NumClients$ signatures so the client can sign whatever other proposals are in play.  We
